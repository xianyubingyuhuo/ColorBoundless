...
职责边界（与既有模块分工）：
    ...
    triage.triage_stage0     Stage 0 快筛结果 → 🟢/🟡/🔴 分流 + 红旗 + 处方（6.15 判定表）
...
LEVEL_FAST = "fast"          # 🟢 快速通道：粗档案 → 直接试色
LEVEL_STANDARD = "standard"  # 🟡 标准：补完测试2/3 → build 档案
LEVEL_DEEP = "deep"          # 🔴 深度：Stage 1+2 + 处方加测
